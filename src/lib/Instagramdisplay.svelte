...
<div class="box ig-bg">
	<a class="is-flex is-justify-content-center" href="https://www.instagram.com/{item.username}">
		<svg class="pl-3 pr-5" xmlns="http://www.w3.org/2000/svg" height="3em" viewBox="0 0 448 512">
			<style>
				svg {
					fill: #ffffff;
				}
